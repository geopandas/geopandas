...
class TestReadFile:
    ...
    def test_read_file(self, df_nybb):
    ...
    def test_filtered_read_file(self, df_nybb):
    ...
    def test_filtered_read_file_with_gdf_boundary(self, df_nybb):
        full_df_shape = df_nybb.shape
        nybb_filename = geopandas.datasets.get_path('nybb')
    ...
    def test_filtered_read_file_with_gdf_boundary_mismatched_crs(self, df_nybb):
        full_df_shape = df_nybb.shape
        nybb_filename = geopandas.datasets.get_path('nybb')
        bbox = geopandas.GeoDataFrame(
            geometry=[box(1031051.7879884212, 224272.49231459625,

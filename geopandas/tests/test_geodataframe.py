...
class TestDataFrame:
    ...
    def test_to_file_with_point_z(self):
        # failing due to problem with iterrows -> overridden implementation
        # in geodataframe.py has a problem when the number of columns
        # matches the number of coordinates

    ...
    def dissolve(
        ...
        **kwargs,
        ...
        by : str or list-like, default None
            ...
            object is provided, the values in the list are treated as categorical labels,
            and polygons will be combined based on the equality of these categorical labels.
